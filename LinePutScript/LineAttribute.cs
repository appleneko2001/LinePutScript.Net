...
public class LineAttribute : Attribute
{
    ...
    public LineAttribute(LpsConvert.ConvertType type = LpsConvert.ConvertType.Default, Type? converter = null,
        string? name = null, Type? iLineType = null, bool fourceToString = false, bool ignoreCase = false)
    {
        Type = type;
        Converter = converter;
        Name = name;
    ...
    /// 转换方法
    /// </summary>
    public LpsConvert.ConvertType Type { get; set; } = LpsConvert.ConvertType.Default;
    ...
    public T ConvertToLine<T>(string name, object? value, bool fourceToString = false) where T : ILine, new()
    {
        ...
        //自动判断
        Type = Type == LpsConvert.ConvertType.Default ? LpsConvert.GetObjectConvertType(value.GetType(), this) : Type;
