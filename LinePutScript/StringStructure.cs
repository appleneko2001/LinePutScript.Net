...
/// </summary>
public class StringStructure : IEnumerable<KeyValuePair<string, string>>, IComparable<string>,
    IDictionary<string, string>, IEnumerable, IComparable<StringStructure>, IGetOBJ<string>
{
    ...
    */
    ...
    public float GetFloat(string key, float defaultValue = default)
    {
        if (Cache.ContainsKey(key))
        {
            return (float)(Convert.ToInt64(Cache[key]) / 1000000000.0);
        }
        else
            return defaultValue;
    }
    ...
    public void SetFloat(string key, float value) => SetString(key, (value * 1000000000).ToString());
    ...
    {
        return string.Compare(getstr(), other, StringComparison.InvariantCulture);
    }
    ...
    {
        return string.Compare(getstr(), other?.getstr(), StringComparison.InvariantCulture);
    }
