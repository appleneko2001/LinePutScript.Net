...
public interface IGetOBJ<T>
{
    ...
    /// <summary>
    /// Get float value from GOBJ object
    /// </summary>
    /// <param name="subName">The field name</param>
    /// <param name="defaultvalue">will be used as default value once its not found.</param>
    /// <returns></returns>
    ...
    public void SetFloat(string subName, float value);
    ...
    /// <returns>获取或设置对 double 属性的Sub</returns>
    public float this[gflt subName] { get; set; }
