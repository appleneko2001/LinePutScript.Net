...
/// </summary>
public class SetObject : ISetObject, IEquatable<SetObject>, IEquatable<string>, IEquatable<long>, IEquatable<int>,
    IEquatable<double>, IEquatable<DateTime>, IEquatable<bool>
{
    /// <summary>
    /// 储存Object的类型
    /// </summary>
    ...
    public string GetStoreString()
    {
        switch (Type)
        {
            ...
            case ObjectType.Float:
                return ((long)((float)Value * 1000000000)).ToString();
    ...
    public float GetFloat()
    {
        switch (Type)
        {
            ...
            case ObjectType.String:
                if (long.TryParse((string)Value, out long result))
                {
                    return (float)(result / 1000000000.0);
                }
                else
                {
                    return 0;
    ...
    {
        return other is not IComparable comparable ? int.MinValue :
